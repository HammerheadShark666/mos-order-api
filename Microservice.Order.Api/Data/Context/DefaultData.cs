...
public class DefaultData
{
    ...
    public static List<Domain.Order> GetOrderDefaultData()
    {
        return
        [
            CreateOrder(new Guid("d3ca8ea8-97d6-41ce-937f-e2d9a905d61e"), new Guid("6c84d0a3-0c0c-435f-9ae0-4de09247ee15"), new Guid("724cbd34-3dff-4e2a-a413-48825f1ab3b9"), "Intergration_Test", "Intergration_Test", 1, [], Helpers.Enums.OrderStatus.Created, 25.99m),
            CreateOrder(new Guid("7b5673fa-166e-417e-a0bf-d2c7d72b6ab3"), new Guid("6c84d0a3-0c0c-435f-9ae0-4de09247ee15"), new Guid("724cbd34-3dff-4e2a-a413-48825f1ab3b9"), "Intergration_Test", "Intergration_Test", 2, [], Helpers.Enums.OrderStatus.Paid, 19.98m),
            CreateOrder(new Guid("6f3e950c-5502-491f-911d-02e112318705"), new Guid("6c84d0a3-0c0c-435f-9ae0-4de09247ee15"), new Guid("724cbd34-3dff-4e2a-a413-48825f1ab3b9"), "Intergration_Test", "Intergration_Test", 3, [], Helpers.Enums.OrderStatus.Dispatched, 2.50m),
            CreateOrder(new Guid("e7cc2320-6443-46bd-93f4-a2ae7b437287"), new Guid("929eaf82-e4fd-4efe-9cae-ce4d7e32d159"), new Guid("b88ef4ce-739f-4c1b-b6d6-9d0727515de8"), "Intergration_Test2", "Intergration_Test2", 4, [], Helpers.Enums.OrderStatus.Recieved, 51.47m),
            CreateOrder(new Guid("30cfccfe-038c-4f20-a306-f0a2a9df0829"), new Guid("929eaf82-e4fd-4efe-9cae-ce4d7e32d159"), new Guid("b88ef4ce-739f-4c1b-b6d6-9d0727515de8"), "Intergration_Test2", "Intergration_Test2", 5, [], Helpers.Enums.OrderStatus.Created, 24.98m),
